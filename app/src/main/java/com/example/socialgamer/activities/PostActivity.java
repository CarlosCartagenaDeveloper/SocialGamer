...
import com.example.socialgamer.models.Post;
import com.example.socialgamer.providers.AuthProvider;
import com.example.socialgamer.providers.ImageProvider;
import com.example.socialgamer.providers.PostProvider;
import com.example.socialgamer.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(PostActivity.this, "com.example.socialgamer", photoFile);
    ...
    private void clearForm() {
        ...
        mImageViewPost1.setImageResource(R.drawable.subir_imagen);
        mImageViewPost2.setImageResource(R.drawable.subir_imagen);
        mTitle = "";
        mDescription = "";
        mCategory = "";
        mImageFile = null;
